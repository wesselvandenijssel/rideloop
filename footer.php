    ...
    <div class="container">
        ...
        <div class="site-footer__bottom">
            ...
            <p class="site-footer__legal">
                <?php
                printf(
                    /* translators: %s: OpenStreetMap copyright link */
                    esc_html__('Map data &copy; %s contributors &middot; Routes are suggestions only &mdash; always ride safely.', 'rideloop'),
