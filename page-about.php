        ...
        <div class="content-narrow">
            ...
            <section class="about-section">
                ...
                <p>
                    <?php
                    printf(
                        /* translators: 1: OSRM link, 2: OpenStreetMap link */
                        esc_html__('RideLoop uses %1$s (Open Source Routing Machine) and %2$s to calculate routes. When you select "Twisties / Scenic," we bias the waypoints away from major highways and toward rural and secondary roads. When you choose "Highways," we optimize for speed. The result is always a closed loop — you end exactly where you started.', 'rideloop'),
                        '<strong>OSRM</strong>',
            ...
            <section class="about-section">
                ...
                <p>
                    <?php esc_html_e('RideLoop runs entirely client-side. Your location is used only to center the map and pre-fill the starting address — it is never stored on our servers. All routing is handled directly between your browser and open routing services.', 'rideloop'); ?>
                </p>
            </section>
